...
*   **Yargıtay İçtihatları:** Türk Medeni Kanunu ve Hukuk Muhakemeleri Kanunu'nun ilgili maddeleri çerçevesinde, Yargıtay'ın ziynet eşyalarının hukuki niteliği, ispat yükü, delil değerlendirmesi ve zamanaşımı konularında geliştirdiği yerleşik içtihatlar, davaların seyrini ve sonucunu doğrudan etkilemektedir. Özellikle Yargıtay 2. Hukuk Dairesi'nin 2024 tarihli içtihat değişikliği (erkeğe ve kadına takılan takıların ayrımı, sandık/torba uygulaması) hakkında detaylı emsal karar analizi için [Avukat Ceren Sümer Cilli'nin düğün takıları davası ve ziynet eşyası paylaşımı rehberine](https://www.cerensumer.av.tr/dugun-takilari-davasi/) göz atabilirsiniz.
...
Türk Medeni Kanunu'na göre, evlilik birliği içinde kadına takılan veya hediye edilen ziynet eşyaları, kadının kişisel malı sayılır. Bu durum, Yargıtay içtihatlarıyla da pekiştirilmiştir. Ziynet eşyaları, evliliğin sona ermesi durumunda [mal paylaşımına](https://adanaailehukuku.com/bosanmada-mal-paylasimi/) tabi tutulmaz ve doğrudan kadına aittir.
...
*   **SEO title:** Ziynet Alacağı Davası: İspat, Liste ve Zamanaşımı | Adana
*   **Meta description:** Ziynet alacağı davası nedir? İspat yükü, ziynet eşyası listesi ve zamanaşımı konularını öğrenin. Adana'da Adana aile hukuku süreci hakkında bilgi edinin.
*   **Slug:** ziynet-alacagi-davasi
*   **Focus keyword:** ziynet alacağı
*   **Secondary keywords:**
    *   Ziynet eşyası
    *   Ziynet davası
    *   Boşanmada ziynet
    *   Ziynet alacağı ispat
    *   Ziynet alacağı zamanaşımı
    *   Ziynet eşyası iadesi
    *   Adana aile hukuku
    *   deneyimli bir aile hukuku avukatı
- **İç link önerileri:**
...
```json
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Ziynet alacağı davası nedir?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Ziynet alacağı davası, evlilik birliği içinde kadına takılan veya hediye edilen ziynet eşyalarının boşanma durumunda iadesi veya bedelinin tahsili amacıyla açılan hukuki bir süreçtir. Türk Medeni Kanunu (TMK) kapsamında değerlendirilir."
      }
    },
    {
      "@type": "Question",
      "name": "Ziynet alacağı davasında ispat yükü kime aittir?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Kural olarak, ziynet eşyalarının varlığını ve kendisinde olmadığını iddia eden eşe, yani genellikle kadına aittir. Ancak eşyaların evden zorla veya rıza dışı götürüldüğünü ispat yükü davalı tarafta olabilir."
      }
    },
    {
      "@type": "Question",
      "name": "Ziynet eşyalarının listesi nasıl belirlenir ve deliller nelerdir?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Ziynet eşyalarının listesi, düğün videoları, fotoğraflar, tanık beyanları, banka kayıtları, eksper raporları gibi çeşitli delillerle belirlenmeye çalışılır. Bu deliller, ziynetlerin türü, adedi ve değeri hakkında mahkemeye bilgi sunar."
      }
    },
    {
      "@type": "Question",
      "name": "Ziynet alacağı davasında zamanaşımı süresi ne kadardır?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Ziynet alacağı, genel zamanaşımı kurallarına tabidir. Sürenin başlangıcı ve kesilmesi somut olayın koşullarına göre değerlendirilir."
      }
    },
    {
      "@type": "Question",
      "name": "Ziynet eşyaları boşanma davası ile birlikte mi talep edilmelidir?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "Adana'da ziynet alacağı davası için hukuki destek alabilir miyim?",
      "acceptedAnswer": {
        "@type": "Answer",
...
```json
{
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://adanaailehukuku.com/ziynet-alacagi-davasi/"
  },
  "headline": "Ziynet Alacağı Davası: İspat, Liste ve Zamanaşımı | Adana",
  "image": [
    "https://adanaailehukuku.com/images/ziynet-alacagi-davasi-gorsel.jpg" 
  ],
  "datePublished": "2023-10-27T09:00:00+03:00", 
  "dateModified": "2023-10-27T09:00:00+03:00", 
  "author": {
    "@type": "Person",
  ...
  "publisher": {
    "@type": "Organization",
    "name": "Adana Aile Hukuku Avukatı Ceren Sümer Cilli",
    "logo": {
      "@type": "ImageObject",
      "url": "https://adanaailehukuku.com/images/logo.png" 
    }
  },
  "description": "Ziynet alacağı davası nedir? İspat yükü, ziynet eşyası listesi ve zamanaşımı konularını öğrenin. Adana'da Adana aile hukuku süreci hakkında bilgi edinin."
}
```
*Not: `image` ve `logo` URL'lerini sitenizin gerçek görselleriyle güncellemeyi unutmayın. `datePublished` ve `dateModified` tarihlerini makalenin yayınlandığı/güncellendiği tarihe göre ayarlayın.*

---

## AI Citation Summary

1.  **Ziynet Alacağı Davasının Tanımı ve Kapsamı:** Evlilik birliği içinde kadına takılan veya hediye edilen ziynet eşyalarının boşanma durumunda iadesi veya bedelinin tahsilini amaçlayan hukuki bir süreçtir.
2.  **İspat Yükü ve Delillerin Önemi:** Ziynet eşyalarının varlığı ve kadından alındığı iddiasının ispat yükü genellikle davacıda olup, düğün videoları, fotoğraflar, tanık beyanları gibi somut delillerle desteklenmesi büyük önem taşır.
3.  **Zamanaşımı:** Ziynet alacağı genel zamanaşımına tabidir; sürenin başlangıcı somut olayda ayrıca değerlendirilir.